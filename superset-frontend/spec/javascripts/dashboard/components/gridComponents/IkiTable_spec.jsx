...
import IkiTable from 'src/dashboard/components/gridComponents/IkiTable';
...
describe('IkiTable', () => {
  const props = {
    id: 'id',
    parentId: 'parentId',
    component: newComponentFactory(IKI_TABLE_TYPE),
    depth: 1,
  ...
  it('should render a div with class "dashboard-component-ikitable"', () => {
    const wrapper = setup();
    expect(wrapper.find('.dashboard-component-ikitable')).toExist();
  });
  ...
  it('should render a HoverMenu with DeleteComponentButton in editMode', () => {
    ...
    // we cannot set props on the IkiTable because of the WithDragDropContext wrapper

...
describe('isValidChild', () => {
  describe('valid calls', () => {
    ...
    const validExamples = [
      ...
      [ROOT, TABS, TAB, IKI_DYNAMIC_MARKDOWN],
      ...
      [ROOT, TABS, TAB, ROW, COLUMN, IKI_DYNAMIC_MARKDOWN],
      ...
      [ROOT, TABS, TAB, ROW, COLUMN, ROW, IKI_DYNAMIC_MARKDOWN],
      ...
      [ROOT, TABS, TAB, ROW, COLUMN, ROW, COLUMN, IKI_DYNAMIC_MARKDOWN],

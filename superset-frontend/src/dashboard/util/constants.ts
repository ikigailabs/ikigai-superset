...
export const NEW_IKI_DYNAMIC_MARKDOWN_ID = 'NEW_IKI_DYNAMIC_MARKDOWN_ID';
...
export const NEW_IKI_EXPLAINABILITY_ID = 'NEW_IKI_EXPLAINABILITY_ID';
export const NEW_IKI_EXTERNAL_DATASETS_ID = 'NEW_IKI_EXTERNAL_DATASETS_ID';
export const NEW_IKI_FORECAST_ID = 'NEW_IKI_FORECAST_ID';
export const NEW_IKI_FORECAST_MODULE_ID = 'NEW_IKI_FORECAST_MODULE_ID';
export const NEW_IKI_DATASET_DOWNLOAD_ID = 'NEW_IKI_DATASET_DOWNLOAD_ID';

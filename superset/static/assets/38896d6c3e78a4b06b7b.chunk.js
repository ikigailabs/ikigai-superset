"use strict";
(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[4893],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "scaleIdentity": () => (/* reexport */ identity),
...
function linear() {
  var scale = continuous(deinterpolateLinear, number/* default */.Z);
...
function log() {
  ...
  scale.ticks = function(count) {
    ...
    if (!(base % 1) && j - i < n) {
      ...
      z = (0,src.ticks)(i, j, Math.min(j - i, n)).map(pows);
    }
  ...
  scale.tickFormat = function(count, specifier) {
    ...
    if (typeof specifier !== "function") specifier = (0,d3_format_src/* format */.WU)(specifier);
...
function quantile() {
  ...
  function rescale() {
    ...
    while (++i < n) thresholds[i - 1] = (0,src.quantile)(domain, i / n);
    return scale;
  }

  function scale(x) {
    if (!isNaN(x = +x)) return range[(0,src.bisect)(thresholds, x)];
  }
...
function quantize() {
  ...
  function scale(x) {
    if (x <= x) return range[(0,src.bisect)(domain, x, 0, n)];
  }
  ...
  function tickInterval(interval, start, stop, step) {
    ...
    if (typeof interval === "number") {
      var target = Math.abs(stop - start) / interval,
          i = (0,src.bisector)(function(i) { return i[2]; }).right(tickIntervals, target);
      if (i === tickIntervals.length) {
        step = (0,src.tickStep)(start / durationYear, stop / durationYear, interval);
        interval = year;
      } else if (i) {
        ...
        step = Math.max((0,src.tickStep)(start, stop, interval), 1);
...
/* harmony default export */ function time() {
  return calendar(d3_time_src/* timeYear */.jB, d3_time_src/* timeMonth */.F0, d3_time_src/* timeWeek */.NG, d3_time_src/* timeDay */.rr, d3_time_src/* timeHour */.WQ, d3_time_src/* timeMinute */.Z_, d3_time_src/* timeSecond */.S1, d3_time_src/* timeMillisecond */.U8, defaultLocale/* timeFormat */.i$).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]);
}
...
/* harmony default export */ function utcTime() {
  return calendar(d3_time_src/* utcYear */.ol, d3_time_src/* utcMonth */.me, d3_time_src/* utcWeek */.YF, d3_time_src/* utcDay */.AN, d3_time_src/* utcHour */.lM, d3_time_src/* utcMinute */.rz, d3_time_src/* utcSecond */.OL, d3_time_src/* utcMillisecond */.GK, defaultLocale/* utcFormat */.g0).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]);
}

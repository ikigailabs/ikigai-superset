...
function DashboardList(props) {
  ...
  const userKey = (0,localStorageHelpers/* getFromLocalStorage */.f)(userId.toString(), null);
    ...
    then(({ json = {} }) => {
      setDashboards(dashboards.map((dashboard) => {var _json$result;
        if (dashboard.id === (json == null ? void 0 : (_json$result = json.result) == null ? void 0 : _json$result.id)) {
          const { changed_by_name, changed_by_url, changed_by, dashboard_title = '', slug = '', json_metadata = '', changed_on_delta_humanized, url = '' } = json.result;
          return {
            ...dashboard,
            changed_by_name,
            changed_by_url,
  ...
  []),
  {
    Cell: ({ row: { original: { url, dashboard_title: dashboardTitle } } }) => (0,emotion_react_browser_esm.jsx)(react_router_dom/* Link */.rU, { to: url }, dashboardTitle),
...

  {
    Cell: ({ row: { original } }) => {
      ...
      (0,emotion_react_browser_esm.jsx)(Icons/* default.Trash */.Z.Trash, { "data-test": "dashboard-list-trash-icon" })))),

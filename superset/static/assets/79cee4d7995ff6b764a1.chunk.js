...
const DatasetModal = ({ addDangerToast, addSuccessToast, onDatasetAdd, onHide, show }) => {
  ...
  const [datasourceId, setDatasourceId] = (0,react.useState)(0);
  ...
  (0,react.useEffect)(() => {
    setDisableSave(isNil_default()(datasourceId) || isEmpty_default()(currentTableName));
  ...
  return (0,emotion_react_browser_esm.jsx)(Modal/* default */.Z, { disablePrimaryButton: disableSave, onHandledPrimaryAction: onSave, onHide: onHide, primaryButtonName: (0,TranslatorSingleton.t)('Add'), show: show, title: (0,TranslatorSingleton.t)('Add dataset') },
  (0,emotion_react_browser_esm.jsx)(TableSelectorContainer, null,
  (0,emotion_react_browser_esm.jsx)(TableSelector/* default */.Z, { clearable: false, dbId: datasourceId, formMode: true, handleError: addDangerToast, onDbChange: onDbChange, onSchemaChange: onSchemaChange, onTableChange: onTableChange, schema: currentSchema, tableName: currentTableName })));
...
const DatasetList = ({ addDangerToast, addSuccessToast, user }) => {
  ...
  const openDatasetEditModal = (0,react.useCallback)(({ id }) => {
    ...
    then(({ json = {} }) => {
      const owners = json.result.owners.map((owner) => owner.id);
  ...
  if (canCreate) {
    ...
    if ((0,featureFlags/* isFeatureEnabled */.cr)(utils_featureFlags/* FeatureFlag.VERSIONED_EXPORT */.T.VERSIONED_EXPORT)) {
      buttonArr.push({
        ...
        (0,emotion_react_browser_esm.jsx)(Icons/* default.Import */.Z.Import, { "data-test": "import-button" })),

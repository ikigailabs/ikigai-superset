...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(60650);
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(38849);
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(21173);
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(69100);
...
/* harmony import */ var src_featureFlags__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(91877);
/* harmony import */ var src_featureFlags__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(46415);
...
/* harmony import */ var src_utils_localStorageHelpers__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(61337);
...
/* harmony import */ var _ChartCard__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(34024);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(11965);
 /**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const PAGE_SIZE = 25;
const PASSWORDS_NEEDED_MESSAGE = (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('The passwords for the databases below are needed in order to ' +
'import them together with the charts. Please note that the ' +
'"Secure Extra" and "Certificate" sections of ' +
'the database configuration are not present in export files, and ' +
'should be added manually after the import if they are needed.');
const CONFIRM_OVERWRITE_MESSAGE = (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('You are importing one or more charts that already exist. ' +
'Overwriting might cause you to lose some of your work. Are you ' +
'sure you want to overwrite?');
(0,src_setup_setupPlugins__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)();
const registry = (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .Z)();
const createFetchDatasets = async (filterValue = '', page, pageSize) => {var _json$result;
  ...
  const { json = {} } = await _superset_ui_core__WEBPACK_IMPORTED_MODULE_22__/* ["default"].get */ .Z.get({
...
const Actions = _superset_ui_core__WEBPACK_IMPORTED_MODULE_23__/* .styled.div */ .iK.div`
  color: ${({ theme }) => theme.colors.grayscale.base};
`;
function ChartList(props) {
  const { addDangerToast, addSuccessToast } = props;
  const { state: { loading, resourceCount: chartCount, resourceCollection: charts, bulkSelectEnabled }, setResourceCollection: setCharts, hasPerm, fetchData, toggleBulkSelect, refreshData } = (0,src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_5__/* .useListViewResource */ .Yi)('chart', (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('chart'), addDangerToast);
  ...
  const userKey = (0,src_utils_localStorageHelpers__WEBPACK_IMPORTED_MODULE_24__/* .getFromLocalStorage */ .f)(userId.toString(), null);
  ...
  const canExport = hasPerm('can_read') && (0,src_featureFlags__WEBPACK_IMPORTED_MODULE_25__/* .isFeatureEnabled */ .cr)(src_featureFlags__WEBPACK_IMPORTED_MODULE_26__/* .FeatureFlag.VERSIONED_EXPORT */ .T.VERSIONED_EXPORT);
  ...
  function handleBulkChartDelete(chartsToDelete) {
    _superset_ui_core__WEBPACK_IMPORTED_MODULE_22__/* ["default"]["delete"] */ .Z["delete"]({
      endpoint: `/api/v1/chart/?q=${rison__WEBPACK_IMPORTED_MODULE_2___default().encode(chartsToDelete.map(({ id }) => id))}` }).
    then(({ json = {} }) => {
      refreshData();
      addSuccessToast(json.message);
    }, (0,src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_4__/* .createErrorHandler */ .v$)((errMsg) => addDangerToast((0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('There was an issue deleting the selected charts: %s', errMsg))));
  }
  const columns = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => [
  ...(props.user.userId ?
  [
  {
    Cell: ({ row: { original: { id } } }) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_FaveStar__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, { itemId: id, saveFaveStar: saveFavoriteStatus, isStarred: favoriteStatus[id] }),
    Header: '',
    id: 'id',
    disableSortBy: true,
    size: 'xs' }] :
  ...
  []),
  {
    Cell: ({ row: { original: { url, slice_name: sliceName } } }) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("a", { href: url, "data-test": `${sliceName}-list-chart-title` },
    sliceName),

    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Chart'),
    accessor: 'slice_name' },

  {
    ...
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Visualization type'),
    accessor: 'viz_type',
    size: 'xxl' },

  {
    Cell: ({ row: { original: { datasource_name_text: dsNameTxt, datasource_url: dsUrl } } }) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("a", { href: dsUrl }, dsNameTxt),
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Dataset'),
    accessor: 'datasource_id',
    disableSortBy: true,
    size: 'xl' },

  {
    Cell: ({ row: { original: { last_saved_by: lastSavedBy, changed_by_url: changedByUrl } } }) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("a", { href: changedByUrl },
    ...
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Modified by'),
    accessor: 'last_saved_by.first_name',
    size: 'xl' },

  {
    Cell: ({ row: { original: { last_saved_at: lastSavedAt } } }) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("span", { className: "no-wrap" },
    lastSavedAt ? moment__WEBPACK_IMPORTED_MODULE_3___default().utc(lastSavedAt).fromNow() : null),

    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Last modified'),
...

  {
    ...
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Created by'),
    accessor: 'created_by',
    disableSortBy: true,
    size: 'xl' },

  {
    Cell: ({ row: { original } }) => {
      ...
      return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(Actions, { className: "actions" },
      canDelete && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_ConfirmStatusChange__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, { title: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Please confirm'), description: (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
        (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Are you sure you want to delete'), ' ',
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("b", null, original.slice_name), "?"),
        onConfirm: handleDelete },
      (confirmDelete) => (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_15__/* .Tooltip */ .u, { id: "delete-action-tooltip", title: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Delete'), placement: "bottom" },
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("span", { "data-test": "trash", role: "button", tabIndex: 0, className: "action-button", onClick: confirmDelete },
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Icons__WEBPACK_IMPORTED_MODULE_16__/* ["default"].Trash */ .Z.Trash, null)))),



      canExport && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_15__/* .Tooltip */ .u, { id: "export-action-tooltip", title: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Export'), placement: "bottom" },
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("span", { role: "button", tabIndex: 0, className: "action-button", onClick: handleExport },
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Icons__WEBPACK_IMPORTED_MODULE_16__/* ["default"].Share */ .Z.Share, null))),


      canEdit && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_15__/* .Tooltip */ .u, { id: "edit-action-tooltip", title: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Edit'), placement: "bottom" },
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("span", { role: "button", tabIndex: 0, className: "action-button", onClick: openEditModal },
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Icons__WEBPACK_IMPORTED_MODULE_16__/* ["default"].EditAlt */ .Z.EditAlt, { "data-test": "edit-alt" }))));



    },
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Actions'),
    id: 'actions',
    disableSortBy: true,
  ...
  const favoritesFilter = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => ({
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Favorite'),
    id: 'id',
    urlDisplay: 'favorite',
    input: 'select',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_10__/* .FilterOperator.chartIsFav */ .p.chartIsFav,
    unfilteredLabel: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Any'),
    selects: [
    { label: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Yes'), value: true },
    { label: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('No'), value: false }] }),

  []);
  const filters = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => [
  {
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Owner'),
    id: 'owners',
    input: 'select',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_10__/* .FilterOperator.relationManyMany */ .p.relationManyMany,
    unfilteredLabel: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('All'),
    fetchSelects: (0,src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_4__/* .createFetchRelated */ .tm)('chart', 'owners', (0,src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_4__/* .createErrorHandler */ .v$)((errMsg) => addDangerToast((0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('An error occurred while fetching chart owners values: %s', errMsg))), props.user),
    paginate: true },

  {
    ...
    unfilteredLabel: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('All'),
    fetchSelects: (0,src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_4__/* .createFetchRelated */ .tm)('chart', 'created_by', (0,src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_4__/* .createErrorHandler */ .v$)((errMsg) => addDangerToast((0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('An error occurred while fetching chart created by values: %s', errMsg))), props.user),
    paginate: true },

  {
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Viz type'),
    id: 'viz_type',
    input: 'select',
  ...
  {
    Header: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Search'),
    id: 'slice_name',
    input: 'search',
  ...
  const sortTypes = [
  {
    desc: false,
    id: 'slice_name',
    label: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Alphabetical'),
    value: 'alphabetical' },

  {
    desc: true,
    id: 'changed_on_delta_humanized',
    label: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Recently modified'),
    value: 'recently_modified' },

  {
    desc: false,
    id: 'changed_on_delta_humanized',
    label: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Least recently modified'),
    value: 'least_recently_modified' }];


  function renderCard(chart) {
    return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(_ChartCard__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z, { chart: chart, showThumbnails: userKey ?
      userKey.thumbnails :
      (0,src_featureFlags__WEBPACK_IMPORTED_MODULE_25__/* .isFeatureEnabled */ .cr)(src_featureFlags__WEBPACK_IMPORTED_MODULE_26__/* .FeatureFlag.THUMBNAILS */ .T.THUMBNAILS), hasPerm: hasPerm, openChartEditModal: openChartEditModal, bulkSelectEnabled: bulkSelectEnabled, addDangerToast: addDangerToast, addSuccessToast: addSuccessToast, refreshData: refreshData, loading: loading, favoriteStatus: favoriteStatus[chart.id], saveFavoriteStatus: saveFavoriteStatus, handleBulkChartExport: handleBulkChartExport });
  }
  const subMenuButtons = [];
  if (canDelete || canExport) {
    subMenuButtons.push({
      name: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Bulk select'),
  ...
  if (canCreate) {
    subMenuButtons.push({
      name: (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
      (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)("i", { className: "fa fa-plus" }), " ", (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Chart')),
    ...
    if ((0,src_featureFlags__WEBPACK_IMPORTED_MODULE_25__/* .isFeatureEnabled */ .cr)(src_featureFlags__WEBPACK_IMPORTED_MODULE_26__/* .FeatureFlag.VERSIONED_EXPORT */ .T.VERSIONED_EXPORT)) {
      subMenuButtons.push({
        name: (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_15__/* .Tooltip */ .u, { id: "import-tooltip", title: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Import charts'), placement: "bottomRight" },
        (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Icons__WEBPACK_IMPORTED_MODULE_16__/* ["default"].Import */ .Z.Import, { "data-test": "import-button" })),
  ...
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
  (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Menu_SubMenu__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z, { name: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Charts'), buttons: subMenuButtons }),
  sliceCurrentlyEditing && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_explore_components_PropertiesModal__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z, { onHide: closeChartEditModal, onSave: handleChartUpdated, show: true, slice: sliceCurrentlyEditing }),
  (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_ConfirmStatusChange__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, { title: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Please confirm'), description: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Are you sure you want to delete the selected charts?'), onConfirm: handleBulkChartDelete },
  (confirmDelete) => {
    const bulkActions = [];
    if (canDelete) {
      bulkActions.push({
        key: 'delete',
        name: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Delete'),
        type: 'danger',
    ...
    if (canExport) {
      bulkActions.push({
        key: 'export',
        name: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('Export'),
        type: 'primary',
        onSelect: handleBulkChartExport });

    }
    return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_ListView__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z, { bulkActions: bulkActions, bulkSelectEnabled: bulkSelectEnabled, cardSortSelectOptions: sortTypes, className: "chart-list-view", columns: columns, count: chartCount, data: charts, disableBulkSelect: toggleBulkSelect, fetchData: fetchData, filters: filters, initialSort: initialSort, loading: loading, pageSize: PAGE_SIZE, renderCard: renderCard, showThumbnails: userKey ?
      userKey.thumbnails :
      (0,src_featureFlags__WEBPACK_IMPORTED_MODULE_25__/* .isFeatureEnabled */ .cr)(src_featureFlags__WEBPACK_IMPORTED_MODULE_26__/* .FeatureFlag.THUMBNAILS */ .T.THUMBNAILS), defaultViewMode: (0,src_featureFlags__WEBPACK_IMPORTED_MODULE_25__/* .isFeatureEnabled */ .cr)(src_featureFlags__WEBPACK_IMPORTED_MODULE_26__/* .FeatureFlag.LISTVIEWS_DEFAULT_CARD_VIEW */ .T.LISTVIEWS_DEFAULT_CARD_VIEW) ?
      'card' :
      'table' });
  }),


  (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_ImportModal_index__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z, { resourceName: "chart", resourceLabel: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_20__.t)('chart'), passwordsNeededMessage: PASSWORDS_NEEDED_MESSAGE, confirmOverwriteMessage: CONFIRM_OVERWRITE_MESSAGE, addDangerToast: addDangerToast, addSuccessToast: addSuccessToast, onModelImport: handleChartImport, show: importingChart, onHide: closeChartImportModal, passwordFields: passwordFields, setPasswordFields: setPasswordFields }),
  preparingExport && (0,_emotion_react__WEBPACK_IMPORTED_MODULE_27__.jsx)(src_components_Loading__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z, null));

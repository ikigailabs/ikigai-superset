"use strict";
(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[1243],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ReactParallelCoordinates)
});
...
var d3_d3 = __webpack_require__(15078);
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-parallel-coordinates/esm/vendor/parcoords/d3.parcoords.js
/* [LICENSE TBD] */

/* eslint-disable */
/* harmony default export */ function d3_parcoords(config) {
  var __ = {
    data: [],
    highlighted: [],
    dimensions: [],
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-parallel-coordinates/esm/vendor/parcoords/divgrid.js
/* [LICENSE TBD] */

/* eslint-disable */
// from http://bl.ocks.org/3687826
/* harmony default export */ function divgrid(config) {
  var columns = [];
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-parallel-coordinates/esm/vendor/parcoords/d3.parcoords.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-parallel-coordinates/esm/ParallelCoordinates.js
/**
...
const propTypes = {
  ...
  data: prop_types_default().arrayOf((prop_types_default()).object),
  width: (prop_types_default()).number,
  height: (prop_types_default()).number,
  colorMetric: (prop_types_default()).string,
  includeSeries: (prop_types_default()).bool,
  linearColorScheme: (prop_types_default()).string,
  metrics: prop_types_default().arrayOf((prop_types_default()).string),
  series: (prop_types_default()).string,
  showDatatable: (prop_types_default()).bool
};
...
function ParallelCoordinates(element, props) {
  ...
  const colorScale = colorMetric ? (0,SequentialSchemeRegistrySingleton/* default */.Z)().get(linearColorScheme).createLinearScale(d3_default().extent(data, d => d[colorMetric])) : () => 'grey';

  const color = d => colorScale(d[colorMetric]);

  const container = d3_default().select(element).classed('superset-legacy-chart-parallel-coordinates', true);
  ...
  const chart = d3_parcoords()(div.node()).width(width).color(color).alpha(0.5).composite('darken').height(effHeight).data(data).dimensions(cols).types(ttypes).render().createAxes().shadows().reorderable().brushMode('1D-axes');
  ...
  if (showDatatable) {
    ...
    chart.on('brush', d => {
      d3_default().select('.grid').datum(d).call(grid).selectAll('.row').on({
        mouseover(dd) {
          chart.highlight([dd]);
        },
...
/* harmony default export */ const esm_ParallelCoordinates = (ParallelCoordinates);
// EXTERNAL MODULE: ./node_modules/@emotion/react/dist/emotion-react.browser.esm.js + 1 modules
var emotion_react_browser_esm = __webpack_require__(11965);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-parallel-coordinates/esm/ReactParallelCoordinates.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const ReactComponent = (0,reactify/* default */.Z)(esm_ParallelCoordinates);
...
/* harmony default export */ const ReactParallelCoordinates = ((0,style/* styled */.iK)(ParallelCoordianes)`

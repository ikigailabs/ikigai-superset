"use strict";
(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[3609],{
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/node_modules/d3-array/src/extent.js
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/node_modules/d3-array/src/range.js
...
// EXTERNAL MODULE: ./node_modules/@superset-ui/core/esm/color/SequentialSchemeRegistrySingleton.js + 1 modules
var SequentialSchemeRegistrySingleton = __webpack_require__(43586);
// EXTERNAL MODULE: ./node_modules/d3-tip/index.js
var d3_tip = __webpack_require__(32383);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/esm/vendor/d3tip.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/esm/vendor/cal-heatmap.js
// [LICENSE TBD]
...
var d3 =  true ? __webpack_require__(15078) : 0;
var d3 =  true ? __webpack_require__(15078) : 0;
...
var CalHeatMap = function () {
  ...
  var self = this;
  self.tip = (0,d3_tip/* default */.Z)().attr('class', 'd3-tip').direction('n').offset([-5, 0]).html(d => `
      ${self.options.timeFormatter(d.t)}: <strong>${self.options.valueFormatter(d.v)}</strong>
    `);
  self.legendTip = (0,d3_tip/* default */.Z)().attr('class', 'd3-tip').direction('n').offset([-5, 0]).html(d => self.options.valueFormatter(d));
...
/* harmony default export */ const cal_heatmap = (CalHeatMap);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/esm/vendor/cal-heatmap.css
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/esm/Calendar.js
/**
...
const propTypes = {
  data: prop_types_default().shape({
    ...
    domain: (prop_types_default()).string,
    range: (prop_types_default()).number,
    // timestamp in milliseconds
    start: (prop_types_default()).number,
    subdomain: (prop_types_default()).string
  }),
  height: (prop_types_default()).number,
  // eslint-disable-next-line react/sort-prop-types
  cellPadding: (prop_types_default()).number,
  // eslint-disable-next-line react/sort-prop-types
  cellRadius: (prop_types_default()).number,
  // eslint-disable-next-line react/sort-prop-types
  cellSize: (prop_types_default()).number,
  linearColorScheme: (prop_types_default()).string,
  showLegend: (prop_types_default()).bool,
  showMetricName: (prop_types_default()).bool,
  showValues: (prop_types_default()).bool,
  steps: (prop_types_default()).number,
  timeFormat: (prop_types_default()).string,
  valueFormat: (prop_types_default()).string,
  verboseMap: (prop_types_default()).object
};
...
function Calendar(element, props) {
  ...
  const valueFormatter = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)(valueFormat);
  const timeFormatter = (0,TimeFormatterRegistrySingleton/* getTimeFormatter */.bt)(timeFormat);
  const container = (0,src_select/* default */.Z)(element).classed('superset-legacy-chart-calendar', true).style('height', height);
  ...
  Object.keys(metricsData).forEach(metric => {
    ...
    const extents = extent(Object.keys(timestamps), key => timestamps[key]);
    const step = (extents[1] - extents[0]) / (steps - 1);
    const colorScale = (0,SequentialSchemeRegistrySingleton/* default */.Z)().get(linearColorScheme).createLinearScale(extents);
    const legend = range(steps).map(i => extents[0] + step * i);
    const legendColors = legend.map(x => colorScale(x));
    const cal = new cal_heatmap();
    cal.init({
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-calendar/esm/ReactCalendar.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const ReactComponent = (0,reactify/* default */.Z)(esm_Calendar);
...
/* harmony default export */ const ReactCalendar = ((0,style/* styled */.iK)(Calender)`

(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[7068],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ esm_ReactWorldMap)
});
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-world-map/node_modules/d3-array/src/extent.js
...
// EXTERNAL MODULE: ./node_modules/datamaps/dist/datamaps.world.min.js
var datamaps_world_min = __webpack_require__(71533);
var datamaps_world_min_default = /*#__PURE__*/__webpack_require__.n(datamaps_world_min);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-world-map/esm/WorldMap.js
/**
...
const propTypes = {
  data: prop_types_default().arrayOf(prop_types_default().shape({
    ...
    m1: (prop_types_default()).number,
    m2: (prop_types_default()).number
  })),
  height: (prop_types_default()).number,
  maxBubbleSize: (prop_types_default()).number,
  showBubbles: (prop_types_default()).bool,
...
function WorldMap(element, props) {
  ...
  const extRadius = d3_default().extent(filteredData, d => Math.sqrt(d.m2));
  const radiusScale = d3_default().scale.linear().domain([extRadius[0], extRadius[1]]).range([1, maxBubbleSize]);
  const colorScale = (0,SequentialSchemeRegistrySingleton/* default */.Z)().get(linearColorScheme).createLinearScale(extent(filteredData, d => d.m1));
  ...
  const map = new (datamaps_world_min_default())({
    element,
    width,
    height,
    data: processedData,
...
/* harmony default export */ const esm_WorldMap = (WorldMap);
// EXTERNAL MODULE: ./node_modules/@emotion/react/dist/emotion-react.browser.esm.js + 1 modules
var emotion_react_browser_esm = __webpack_require__(11965);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-world-map/esm/ReactWorldMap.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const ReactWorldMap = (0,reactify/* default */.Z)(esm_WorldMap);
...
const WorldMapComponent = ({
  ...
  className: className
}, (0,emotion_react_browser_esm.jsx)(ReactWorldMap, otherProps));

WorldMapComponent.propTypes = {
  className: (prop_types_default()).string.isRequired
};
/* harmony default export */ const esm_ReactWorldMap = ((0,style/* styled */.iK)(WorldMapComponent)`

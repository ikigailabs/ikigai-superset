...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(69100);
...
function SearchFilter({ Header, name, initialValue, onSubmit }) {
  ...
  (0,emotion_react_browser_esm.jsx)(StyledInput, { allowClear: true, "data-test": "filters-search", placeholder: (0,TranslatorSingleton.t)('Type a value'), name: name, value: value, onChange: handleChange, onPressEnter: handleSubmit, onBlur: handleSubmit, prefix: (0,emotion_react_browser_esm.jsx)(SearchIcon, { iconSize: "l" }) }));
...
function SelectFilter({ Header, name, fetchSelects, initialValue, onSelect, selects = [] }) {
  ...
  (0,emotion_react_browser_esm.jsx)(src_components/* Select */.P, { allowClear: true, ariaLabel: typeof Header === 'string' ? Header : name || (0,TranslatorSingleton.t)('Filter'), labelInValue: true, "data-test": "filters-select", header: (0,emotion_react_browser_esm.jsx)(Form/* FormLabel */.lX, null, Header), onChange: onChange, onClear: onClear, options: fetchSelects ? fetchAndFormatSelects : selects, placeholder: (0,TranslatorSingleton.t)('Select or type a value'), showSearch: true, value: selectedOption }));
...
function ListView({ columns, data, count, pageSize: initialPageSize, fetchData, loading, initialSort = [], className = '', filters = [], bulkActions = [], bulkSelectEnabled = false, disableBulkSelect = () => {}, renderBulkSelectCopy = (selected) => (0,TranslatorSingleton.t)('%s Selected', selected.length), renderCard, showThumbnails, cardSortSelectOptions, defaultViewMode = 'card', highlightRowId, emptyState = {} }) {
  ...
  (0,emotion_react_browser_esm.jsx)("div", { "data-test": className, className: `superset-list-view ${className}` },
  ...
  bulkSelectEnabled && (0,emotion_react_browser_esm.jsx)(BulkSelectWrapper, { "data-test": "bulk-select-controls", type: "info", closable: true, showIcon: false, onClose: disableBulkSelect, message: (0,emotion_react_browser_esm.jsx)(react.Fragment, null,
    (0,emotion_react_browser_esm.jsx)("div", { className: "selectedCopy", "data-test": "bulk-select-copy" },
    renderBulkSelectCopy(selectedFlatRows)),

    Boolean(selectedFlatRows.length) && (0,emotion_react_browser_esm.jsx)(react.Fragment, null,
    (0,emotion_react_browser_esm.jsx)("span", { "data-test": "bulk-select-deselect-all", role: "button", tabIndex: 0, className: "deselect-all", onClick: () => toggleAllRowsSelected(false) },
    (0,TranslatorSingleton.t)('Deselect all')),

    (0,emotion_react_browser_esm.jsx)("div", { className: "divider" }),
    bulkActions.map((action) => (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { "data-test": "bulk-select-action", key: action.key, buttonStyle: action.type, cta: true, onClick: () => action.onSelect(selectedFlatRows.map((r) => r.original)) },
    action.name)))) }),

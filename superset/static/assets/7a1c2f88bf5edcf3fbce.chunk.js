...
// EXTERNAL MODULE: ./src/explore/components/controls/SelectAsyncControl/index.tsx
var SelectAsyncControl = __webpack_require__(185);
...
class CRUDCollection extends react.PureComponent {
  ...
  renderItem(record) {
    ...
    if (allowDeletes) {
      tds.push((0,emotion_react_browser_esm.jsx)("td", { key: "__actions", "data-test": "crud-delete-option", className: "text-primary" },
      (0,emotion_react_browser_esm.jsx)(Icons/* default.Trash */.Z.Trash, { "aria-label": "Delete item", className: "pointer", "data-test": "crud-delete-icon", role: "button", tabIndex: 0, onClick: this.deleteItem.bind(this, record.id) })));
  ...
  renderTableBody() {
    ...
    return (0,emotion_react_browser_esm.jsx)("tbody", { "data-test": "table-content-rows" }, content);
  }
  render() {
    ...
    (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { buttonSize: "small", buttonStyle: "tertiary", onClick: this.onAddItem, "data-test": "add-item-button" },
    (0,emotion_react_browser_esm.jsx)("i", { "data-test": "crud-add-table-item", className: "fa fa-plus" }), ' ',
    ...
    (0,emotion_react_browser_esm.jsx)("table", { "data-test": "crud-table", className: "table" },
...
const DatasourceEditor_defaultProps = {
  onChange: () => {} };var _ref2 =  true ? { name: "hkh81z", styles: "margin-top:8px" } : 0;var _ref3 =  true ? { name: "hkh81z", styles: "margin-top:8px" } : 0;
...
class DatasourceEditor extends react.PureComponent {
  ...
  renderSettingsFieldset() {
    ...
    return (
      ...
      (0,emotion_react_browser_esm.jsx)(Field, {
        fieldKey: "owners",
        label: (0,TranslatorSingleton.t)('Owners'),
        description: (0,TranslatorSingleton.t)('Owners of the dataset'),
        control:
        (0,emotion_react_browser_esm.jsx)(SelectAsyncControl/* default */.Z, {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(69100);
...
/* harmony import */ var src_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4715);
/* harmony import */ var src_components_Label__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37921);
/* harmony import */ var src_components_Form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(58347);
...
function DatabaseSelector({ db, formMode = false, getDbList, handleError, isDatabaseSelectEnabled = true, onDbChange, onSchemaChange, onSchemasLoad, readOnly = false, schema, sqlLabMode = false }) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (currentDb) {
      ...
      try {
        ...
        _superset_ui_core__WEBPACK_IMPORTED_MODULE_8__/* ["default"].get */ .Z.get({ endpoint }).then(({ json }) => {
  ...
  function renderDatabaseSelect() {
    return renderSelectRow((0,_emotion_react__WEBPACK_IMPORTED_MODULE_7__.jsx)(src_components__WEBPACK_IMPORTED_MODULE_2__/* .Select */ .P, { ariaLabel: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_9__.t)('Select database or type database name'), optionFilterProps: ['database_name', 'value'], "data-test": "select-database", header: (0,_emotion_react__WEBPACK_IMPORTED_MODULE_7__.jsx)(src_components_Form__WEBPACK_IMPORTED_MODULE_4__/* .FormLabel */ .lX, null, (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_9__.t)('Database')), lazyLoading: false, onChange: changeDataBase, value: currentDb, placeholder: (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_9__.t)('Select database or type database name'), disabled: !isDatabaseSelectEnabled || readOnly, options: loadDatabases }), null);
  }
  ...
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_7__.jsx)(DatabaseSelectorWrapper, { "data-test": "DatabaseSelector" },
...
function EditableTitle({ canEdit = false, editing = false, extraClasses, multiLine = false, noPermitTooltip, onSaveTitle, showTooltip = true, style, title = '', defaultTitle = '', placeholder = '' }) {
  ...
  if (!canEdit) {
    ...
    titleComponent = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", { "data-test": "editable-title-input", title: value },
    value);

  }
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", { "data-test": "editable-title", className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('editable-title', extraClasses, canEdit && 'editable-title--editable', isEditing && 'editable-title--editing'), style: style },
  titleComponent);
...
/* harmony import */ var src_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4715);
/* harmony import */ var src_components_Form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(58347);
...
const TableSelector = ({ database, dbId, formMode = false, getDbList, handleError, isDatabaseSelectEnabled = true, onDbChange, onSchemaChange, onSchemasLoad, onTableChange, onTablesLoad, readOnly = false, schema, sqlLabMode = true, tableName }) => {
  const [currentDbId, setCurrentDbId] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(dbId);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (currentDbId && currentSchema) {
      ...
      // TODO: Would be nice to add pagination in a follow-up. Needs endpoint changes.
      const endpoint = encodeURI(`/superset/tables/${currentDbId}/${encodedSchema}/undefined/${forceRefresh}/`);
      if (previousRefresh !== refresh) {
        setPreviousRefresh(refresh);
      }
      try {
        _superset_ui_core__WEBPACK_IMPORTED_MODULE_10__/* ["default"].get */ .Z.get({ endpoint }).then(({ json }) => {
          const options = [];
          let currentTable;
  ...
  const internalDbChange = (db) => {
    setCurrentDbId(db == null ? void 0 : db.id);
    if (onDbChange) {
      onDbChange(db);
    }
  };

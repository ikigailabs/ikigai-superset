...
const ExtraOptions = ({ db, onInputChange, onTextChange, onEditorChange, onExtraInputChange, onExtraEditorChange }) => {var _db$extra_json, _db$extra_json2, _db$extra_json3, _db$extra_json3$metad, _db$extra_json4, _db$extra_json4$metad, _db$extra_json5, _db$extra_json6, _db$extra_json7, _db$extra_json8, _db$extra_json9;
  ...
  (0,emotion_react_browser_esm.jsx)("input", { type: "number", name: "schema_cache_timeout", value: (db == null ? void 0 : (_db$extra_json3 = db.extra_json) == null ? void 0 : (_db$extra_json3$metad = _db$extra_json3.metadata_cache_timeout) == null ? void 0 : _db$extra_json3$metad.schema_cache_timeout) ||
    '', placeholder: (0,TranslatorSingleton.t)('Enter duration in seconds'), onChange: onExtraInputChange, "data-test": "schema-cache-timeout-test" })),
  ...
  (0,emotion_react_browser_esm.jsx)("input", { type: "number", name: "table_cache_timeout", value: (db == null ? void 0 : (_db$extra_json4 = db.extra_json) == null ? void 0 : (_db$extra_json4$metad = _db$extra_json4.metadata_cache_timeout) == null ? void 0 : _db$extra_json4$metad.table_cache_timeout) ||
    '', placeholder: (0,TranslatorSingleton.t)('Enter duration in seconds'), onChange: onExtraInputChange, "data-test": "table-cache-timeout-test" })),
  ...
  (0,emotion_react_browser_esm.jsx)(StyledInputContainer, { css: /*#__PURE__*/(0,emotion_react_browser_esm.css)({ no_margin_bottom: no_margin_bottom },  true ? "" : 0,  true ? "" : 0) },
  (0,emotion_react_browser_esm.jsx)("div", { className: "input-container" },
  (0,emotion_react_browser_esm.jsx)(IndeterminateCheckbox/* default */.Z, { id: "impersonate_user", indeterminate: false, checked: !!(db != null && db.impersonate_user), onChange: onInputChange, labelText: (0,TranslatorSingleton.t)('Impersonate logged in user (Presto, Trino, Hive, and GSheets)') }),
  ...
  (0,emotion_react_browser_esm.jsx)(StyledInputContainer, null,
  (0,emotion_react_browser_esm.jsx)("div", { className: "control-label", "data-test": "version-label-test" },
  (0,TranslatorSingleton.t)('Version')),

  (0,emotion_react_browser_esm.jsx)("div", { className: "input-container", "data-test": "version-spinbutton-test" },
...
const SqlAlchemyTab = ({ db, onInputChange, testConnection, conf, isEditMode = false }) => {var _conf$SQLALCHEMY_DOCS, _conf$SQLALCHEMY_DISP;return (0,emotion_react_browser_esm.jsx)(react.Fragment, null,
  ...
  (0,emotion_react_browser_esm.jsx)("div", { className: "input-container" },
  (0,emotion_react_browser_esm.jsx)("input", { type: "text", name: "database_name", "data-test": "database-name-input", value: (db == null ? void 0 : db.database_name) || '', placeholder: (0,TranslatorSingleton.t)('Name your database'), onChange: onInputChange })),
  ...
  (0,emotion_react_browser_esm.jsx)("div", { className: "input-container" },
  (0,emotion_react_browser_esm.jsx)("input", { type: "text", name: "sqlalchemy_uri", "data-test": "sqlalchemy-uri-input", value: (db == null ? void 0 : db.sqlalchemy_uri) || '', autoComplete: "off", placeholder: (0,TranslatorSingleton.t)('dialect+driver://username:password@host:port/database'), onChange: onInputChange })),
...
// EXTERNAL MODULE: ./src/components/Form/LabeledErrorBoundInput.tsx
var LabeledErrorBoundInput = __webpack_require__(52323);
...
const DatabaseModal = ({ addDangerToast, addSuccessToast, onDatabaseAdd, onHide, show, databaseId }) => {var _availableDbs$databas3;
  ...
  const renderModalFooter = () => {
    if (db) {
      ...
      (0,emotion_react_browser_esm.jsx)(StyledFooterButton, { key: "submit", buttonStyle: "primary", onClick: onSave, "data-test": "modal-confirm-button" }, "Finish"));
  ...
  (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { "data-test": "sqla-connect-btn", buttonStyle: "link", onClick: () => setDB({
      type: ActionType.configMethodChange,
      payload: {
        engine: db.engine,
        configuration_method: CONFIGURATION_METHOD.SQLALCHEMY_URI,
...
function DatabaseList({ addDangerToast, addSuccessToast }) {
...

  {
    Cell: ({ row: { original } }) => {
      ...
      canDelete && (0,emotion_react_browser_esm.jsx)("span", { role: "button", tabIndex: 0, className: "action-button", "data-test": "database-delete", onClick: handleDelete },
      ...
      (0,emotion_react_browser_esm.jsx)("span", { role: "button", "data-test": "database-edit", tabIndex: 0, className: "action-button", onClick: handleEdit },
      (0,emotion_react_browser_esm.jsx)(Icons/* default.EditAlt */.Z.EditAlt, { "data-test": "edit-alt" }))));

(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[7828],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ReactPivotTable)
});

// EXTERNAL MODULE: ./node_modules/@superset-ui/core/esm/chart/components/reactify.js
var reactify = __webpack_require__(73834);
// EXTERNAL MODULE: ./node_modules/datatables.net-bs/js/dataTables.bootstrap.js
var dataTables_bootstrap = __webpack_require__(47036);
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-pivot-table/esm/utils/formatCells.js
/**
...
function formatCellValue(i, cols, tdText, columnFormats, numberFormat, dateRegex, dateFormatter) {
  ...
  if (parseFloat(tdText)) {
    ...
    textContent = (0,NumberFormatterRegistrySingleton/* formatNumber */.uf)(format, parsedValue);
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-pivot-table/esm/utils/fixTableHeight.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-pivot-table/esm/PivotTable.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
if (window.$) {
  dataTables_bootstrap_default()(window, window.$);
}

const $ = window.$ || (dataTables_bootstrap_default()).$;
const propTypes = {
  data: prop_types_default().shape({
    // TODO: replace this with raw data in SIP-6
    html: (prop_types_default()).string,
    columns: prop_types_default().arrayOf(prop_types_default().oneOfType([(prop_types_default()).string, prop_types_default().arrayOf((prop_types_default()).string)]))
  }),
  height: (prop_types_default()).number,
  columnFormats: prop_types_default().objectOf((prop_types_default()).string),
  numberFormat: (prop_types_default()).string,
  numGroups: (prop_types_default()).number,
  verboseMap: prop_types_default().objectOf((prop_types_default()).string)
};
...
function PivotTable(element, props) {
  ...
  if (dateFormat === smartDate/* default.id */.Z.id && granularity) {
    dateFormatter = (0,TimeFormatterRegistrySingleton/* getTimeFormatterForGranularity */.uh)(granularity);
  } else if (dateFormat) {
    dateFormatter = (0,TimeFormatterRegistrySingleton/* getTimeFormatter */.bt)(dateFormat);
  } else {
    ...
    $(this).find('td').each(function eachTd(index) {
      if (hasOnlyTextChild(this)) {
        ...
        const {
          textContent,
          sortAttributeValue
        } = formatCellValue(index, cols, tdText, columnFormats, numberFormat, dateRegex, dateFormatter);
...
/* harmony default export */ const esm_PivotTable = (PivotTable);
;// CONCATENATED MODULE: ./node_modules/@superset-ui/legacy-plugin-chart-pivot-table/esm/ReactPivotTable.js
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
/* harmony default export */ const ReactPivotTable = ((0,reactify/* default */.Z)(esm_PivotTable));
	...
	if ( typeof define === 'function' && define.amd ) {
		...
		module.exports = function (root, $) {
			...
			if ( ! $ || ! $.fn.dataTable ) {
				...
				$ = __webpack_require__(68288)(root, $).$;
			}
		...
		module.exports = function (root, $) {
			...
			if ( ! $ ) {
				$ = typeof window !== 'undefined' ? // jQuery's factory checks for a global window
					...
					__webpack_require__(19755)( root );
			}

...
module.exports = { "default": __webpack_require__(11358), __esModule: true };
...
// EXTERNAL MODULE: ./src/common/hooks/useComponentDidMount/index.ts
var useComponentDidMount = __webpack_require__(36644);
...
const parentMaxDepthLookup = {
  ...
  [componentTypes/* DASHBOARD_GRID_TYPE */.BG]: {
    ...
    [componentTypes/* IKI_PROCESS_BUILDER_TYPE */.Ap]: depthOne,
  ...
  [componentTypes/* TAB_TYPE */.gn]: {
    ...
    [componentTypes/* IKI_PROCESS_BUILDER_TYPE */.Ap]: depthFive,
  ...
  [componentTypes/* IKI_PROCESS_BUILDER_TYPE */.Ap]: {} };
...
var src_components = __webpack_require__(4715);
  ...
  visType })
{
  return (
    ...
    (0,emotion_react_browser_esm.jsx)("div", { className: "card-title", "data-test": "card-title" },
    sliceName),
...
;// CONCATENATED MODULE: ./src/dashboard/components/gridComponents/new/NewIkiProcessBuilder.jsx
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
function NewIkiProcessBuilder_DraggableNewDivider() {
  return (
    (0,emotion_react_browser_esm.jsx)(DraggableNewComponent, {
      id: constants/* NEW_IKI_PROCESS_BUILDER_ID */.uq,
      type: componentTypes/* IKI_PROCESS_BUILDER_TYPE */.Ap,
      label: (0,TranslatorSingleton.t)('Process Builder'),
...
(0,emotion_react_browser_esm.jsx)(BuilderComponentPaneTabs, { id: "tabs", className: "tabs-components", "data-test": "dashboard-builder-component-pane-tabs-navigation" },
...
(0,emotion_react_browser_esm.jsx)(NewIkiProcessBuilder_DraggableNewDivider, null)),
...
// EXTERNAL MODULE: ./src/components/Form/index.tsx
var Form = __webpack_require__(58347);
...
class SaveModal extends react.PureComponent {
  ...
  render() {
    return (0,emotion_react_browser_esm.jsx)(ModalTrigger/* default */.Z, { ref: this.setModalRef, triggerNode: this.props.triggerNode, modalTitle: (0,TranslatorSingleton.t)('Save dashboard'), modalBody: (0,emotion_react_browser_esm.jsx)("div", null,
      ...
      (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { "data-test": "modal-save-dashboard-button", buttonStyle: "primary", onClick: this.saveDashboard },
...
class HeaderActionsDropdown extends react.PureComponent {
  ...
  render() {
    ...
    (0,emotion_react_browser_esm.jsx)(components_SaveModal, {
      ...
      onSave: onSave,
      triggerNode:
      (0,emotion_react_browser_esm.jsx)("span", { "data-test": "save-as-menu-item" }, (0,TranslatorSingleton.t)('Save as')),
...
// EXTERNAL MODULE: ./src/dashboard/components/PropertiesModal/index.jsx + 1 modules
var PropertiesModal = __webpack_require__(13272);
...
function getFormDataWithExtraFilters({ chart, charts, filters, nativeFilters, chartConfiguration, colorScheme, colorNamespace, sliceId, layout, dataMask }) {
...
const Footer = ({ onCancel, handleSave, onDismiss, onConfirmCancel, saveAlertVisible }) => {
  if (saveAlertVisible) {
  ...
  return (0,emotion_react_browser_esm.jsx)(react.Fragment, null,
  (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { key: "cancel", buttonStyle: "secondary", "data-test": "native-filter-modal-cancel-button", onClick: onCancel },
  (0,TranslatorSingleton.t)('Cancel')),

  (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { key: "submit", buttonStyle: "primary", onClick: handleSave, "data-test": "native-filter-modal-save-button" },
  (0,TranslatorSingleton.t)('Save')));
...
const StyledHeader = style/* styled.div */.iK.div`
  ...
  `}
`;
const FilterTabs = ({ onEdit, getFilterTitle, onChange, currentFilterId, filterIds = [], removedFilters = [], restoreFilter, children }) => (0,emotion_react_browser_esm.jsx)(FilterTabsContainer, { id: "native-filters-tabs", type: "editable-card", tabPosition: "left", onChange: onChange, activeKey: currentFilterId, onEdit: onEdit, hideAdd: true, tabBarExtraContent: {
    ...
    (0,emotion_react_browser_esm.jsx)("span", { "data-test": "add-filter-button", "aria-label": "Add filter" },
    (0,TranslatorSingleton.t)('Add filter'))) } },



filterIds.map((id) => (0,emotion_react_browser_esm.jsx)(components_Tabs/* LineEditableTabs.TabPane */.cl.TabPane, { tab: (0,emotion_react_browser_esm.jsx)(FilterTabTitle, { className: removedFilters[id] ? 'removed' : '' },
  (0,emotion_react_browser_esm.jsx)(StyledFilterTitle, null,
  removedFilters[id] ? (0,TranslatorSingleton.t)('(Removed)') : getFilterTitle(id)),

  removedFilters[id] && (0,emotion_react_browser_esm.jsx)(FilterTabs_StyledSpan, { role: "button", "data-test": "undo-button", tabIndex: 0, onClick: () => restoreFilter(id) },
...
`;
function BasicErrorAlert({ body, level, title }) {
  const theme = (0,style/* useTheme */.Fg)();
  return (0,emotion_react_browser_esm.jsx)(StyledContainer, { level: level, role: "alert" },
  !level || level === 'error' ? (0,emotion_react_browser_esm.jsx)(Icons/* default.ErrorSolid */.Z.ErrorSolid, { iconColor: theme.colors.error.base }) : (0,emotion_react_browser_esm.jsx)(Icons/* default.WarningSolid */.Z.WarningSolid, { iconColor: theme.colors[level].base }),
...
(0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { "data-test": "restore-filter-button", buttonStyle: "primary", onClick: onClick },
...
const FiltersConfigForm = ({ filterId, filterToEdit, removedFilters, restoreFilter, form, parentFilters }, ref) => {var _form$getFieldValue, _formFilter$parentFil, _filterToEdit$cascade, _formFilter$dataset2, _nativeFilterItems$fo, _nativeFilterItems$fo2, _ref, _formFilter$dataset$v, _formFilter$dataset3, _filterToEdit$targets, _nativeFilterItems$fo3, _nativeFilterItem$val, _formFilter$isDataDir, _formFilter$dataset6, _filterToEdit$adhoc_f, _formFilter$controlVa, _filterToEdit$control, _filterToEdit$control2, _formFilter$controlVa2, _formFilter$adhoc_fil, _formFilter$controlVa3, _formFilter$dataset9, _datasetDetails$colum;
  ...
  (0,emotion_react_browser_esm.jsx)(CollapsibleControl, { title: (0,TranslatorSingleton.t)('Filter has default value'), initialValue: hasDefaultValue, disabled: isRequired || defaultToFirstItem, tooltip: defaultValueTooltip, checked: hasDefaultValue, onChange: (value) => {
      setHasDefaultValue(value);
      formChanged();
    } },
  !isRemoved && (0,emotion_react_browser_esm.jsx)(StyledRowSubFormItem, { name: ['filters', filterId, 'defaultDataMask'], initialValue: initialDefaultValue, "data-test": "default-input", label: (0,emotion_react_browser_esm.jsx)(StyledLabel, null, (0,TranslatorSingleton.t)('Default Value')), required: hasDefaultValue, rules: [
    {
  ...
  isCascadingFilter && (0,emotion_react_browser_esm.jsx)(CollapsibleControl, { title: (0,TranslatorSingleton.t)('Filter is hierarchical'), initialValue: hasParentFilter, onChange: (checked) => {
      formChanged();
      if (checked) {
  ...
  (0,emotion_react_browser_esm.jsx)(StyledRowSubFormItem, { name: ['filters', filterId, 'parentFilter'], label: (0,emotion_react_browser_esm.jsx)(StyledLabel, null, (0,TranslatorSingleton.t)('Parent filter')), initialValue: parentFilter, normalize: (value) => value ? { value } : undefined, "data-test": "parent-filter-input", required: true, rules: [
    {
      required: true,
  ...
  filter((key) => !BASIC_CONTROL_ITEMS.includes(key)).
  map((key) => controlItems[key].element),
  hasDataset && hasAdditionalFilters && (0,emotion_react_browser_esm.jsx)(CollapsibleControl, { title: (0,TranslatorSingleton.t)('Pre-filter available values'), initialValue: hasPreFilter, onChange: (checked) => {
      formChanged();
      if (checked) {
        validatePreFilter();
      }
  ...
  (formFilter == null ? void 0 : formFilter.filterType) !== 'filter_range' && (0,emotion_react_browser_esm.jsx)(CollapsibleControl, { title: (0,TranslatorSingleton.t)('Sort filter values'), onChange: (checked) => {
...
function FiltersConfigModal({ isOpen, initialFilterId, createNewOnOpen, onSave, onCancel }) {
  ...
  const getFilterTitle = (id) => {var _ref, _formValues$filters$i, _formValues$filters$i2, _filterConfigMap$id;return (_ref = (_formValues$filters$i = (_formValues$filters$i2 = formValues.filters[id]) == null ? void 0 : _formValues$filters$i2.name) != null ? _formValues$filters$i : (_filterConfigMap$id =
    ...
    (0,TranslatorSingleton.t)('New filter');};
  ...
  const onValuesChange = (0,react.useMemo)(() => debounce_default()((changes, values) => {
    if (changes.filters &&
    Object.values(changes.filters).some((filter) => filter.name != null)) {
      // we only need to set this if a name changed
      setFormValues(values);
    }
    setSaveAlertVisible(false);
  }, src_constants/* SLOW_DEBOUNCE */.M$), []);
  return (0,emotion_react_browser_esm.jsx)(StyledModalWrapper, { visible: isOpen, maskClosable: false, title: (0,TranslatorSingleton.t)('Filters configuration and scoping'), width: "50%", destroyOnClose: true, onCancel: handleCancel, onOk: handleSave, centered: true, "data-test": "filter-modal", footer: (0,emotion_react_browser_esm.jsx)(Footer_Footer, { onDismiss: () => setSaveAlertVisible(false), onCancel: handleCancel, handleSave: handleSave, saveAlertVisible: saveAlertVisible, onConfirmCancel: handleConfirmCancel }) },
  ...
  (0,emotion_react_browser_esm.jsx)(FiltersConfigModal_FilterTabs, { onEdit: handleTabEdit, onChange: setCurrentFilterId, getFilterTitle: getFilterTitle, currentFilterId: currentFilterId, filterIds: filterIds, removedFilters: removedFilters, restoreFilter: restoreFilter },
  (id) => (0,emotion_react_browser_esm.jsx)(FiltersConfigForm_FiltersConfigForm, { ref: configFormRef, form: form, filterId: id, filterToEdit: filterConfigMap[id], removedFilters: removedFilters, restoreFilter: restoreFilter, parentFilters: getParentFilters(id) }))))));
...
const CrossFilterScopingModal = ({ isOpen, chartId, onClose }) => {var _chartConfig$chartId, _chartConfig$chartId$;
  ...
  return (0,emotion_react_browser_esm.jsx)(Modal/* StyledModal */.o, { visible: isOpen, maskClosable: false, title: (0,TranslatorSingleton.t)('Cross Filter Scoping'), width: "55%", destroyOnClose: true, onCancel: onClose, onOk: handleSave, centered: true, "data-test": "cross-filter-scoping-modal", footer: (0,emotion_react_browser_esm.jsx)(react.Fragment, null,
    (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { key: "cancel", buttonStyle: "secondary", "data-test": "cross-filter-scoping-modal-cancel-button", onClick: onClose },
    (0,TranslatorSingleton.t)('Cancel')),

    (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { key: "submit", buttonStyle: "primary", onClick: handleSave, "data-test": "cross-filter-scoping-modal-save-button" },
    (0,TranslatorSingleton.t)('Save'))) },
...
class SliceHeaderControls extends react.PureComponent {
  ...
  render() {var _slice$form_data;
    ...
    const menu = (0,emotion_react_browser_esm.jsx)(components/* Menu */.v2, { onClick: this.handleMenuClick, selectable: false, "data-test": `slice_${slice.slice_id}-menu` },
    (0,emotion_react_browser_esm.jsx)(components/* Menu.Item */.v2.Item, { key: SliceHeaderControls_MENU_KEYS.FORCE_REFRESH, disabled: this.props.chartStatus === 'loading', style: { height: 'auto', lineHeight: 'initial' }, "data-test": "refresh-chart-menu-item" },
    (0,TranslatorSingleton.t)('Force refresh'),
    (0,emotion_react_browser_esm.jsx)(RefreshTooltip, { "data-test": "dashboard-slice-refresh-tooltip" },
    refreshTooltip)),
    ...
    (0,emotion_react_browser_esm.jsx)(ModalTrigger/* default */.Z, { triggerNode: (0,emotion_react_browser_esm.jsx)("span", { "data-test": "view-query-menu-item" }, (0,TranslatorSingleton.t)('View query')), modalTitle: (0,TranslatorSingleton.t)('View query'), modalBody: (0,emotion_react_browser_esm.jsx)(ViewQueryModal/* default */.Z, { latestQueryFormData: this.props.formData }), draggable: true, resizable: true, responsive: true })),
...
const FiltersBadge = ({ chartId }) => {var _dashboardInfo$metada, _dashboardInfo$metada4;
  ...
  !isInactive && (0,emotion_react_browser_esm.jsx)("span", { "data-test": "applied-filter-count" },
  ...
  (0,emotion_react_browser_esm.jsx)("span", { "data-test": "incompatible-filter-count" },
  incompatibleIndicators.length)) :
...
const SliceHeader = ({ innerRef = null, forceRefresh = () => ({}), updateSliceName = () => ({}), toggleExpandSlice = () => ({}), logExploreChart = () => ({}), exploreUrl = '#', exportCSV = () => ({}), editMode = false, annotationQuery = {}, annotationError = {}, cachedDttm = null, updatedDttm = null, isCached = [], isExpanded = false, sliceName = '', supersetCanExplore = false, supersetCanShare = false, supersetCanCSV = false, sliceCanEdit = false, exportFullCSV, slice, componentId, dashboardId, addSuccessToast, addDangerToast, handleToggleFullSize, isFullSize, chartStatus, formData }) => {
  ...
  [crossFilterValue]);
  return (0,emotion_react_browser_esm.jsx)("div", { className: "chart-header", "data-test": "slice-header", ref: innerRef },
...
ownProps)
{var _dashboardInfo$metada, _dataMask$id, _dataMask$id2;
  const { id } = ownProps;
...
class URLShortLinkButton extends react.Component {
  ...
  renderPopover() {
    ...
    return (
      (0,emotion_react_browser_esm.jsx)("div", { id: "shorturl-popover", "data-test": "shorturl-popover" },
...
const HoverStyleOverrides = style/* styled.div */.iK.div`
  .hover-menu {
    opacity: 0;
    position: absolute;
...
class HoverMenu extends react.PureComponent {
  ...
  render() {
    ...
    return (0,emotion_react_browser_esm.jsx)(HoverStyleOverrides, { className: "hover-menu-container" },
    (0,emotion_react_browser_esm.jsx)("div", { ref: innerRef, className: classnames_default()('hover-menu', position === 'left' && 'hover-menu--left', position === 'top' && 'hover-menu--top') },
    children));
...
class ChartHolder extends react.Component {
  ...
  render() {var _getComponentById, _getComponentById$met, _parentComponent$pare;
    ...
    return (
      ...
      (0,emotion_react_browser_esm.jsx)("div", { "data-test": "dashboard-delete-component-button" },
...
IkiTable.propTypes = IkiTable_propTypes;
IkiTable.defaultProps = IkiTable_defaultProps;
...
/* harmony default export */ const gridComponents_IkiTable = ((0,es/* connect */.$j)(IkiTable_mapStateToProps)(IkiTable));
// EXTERNAL MODULE: ./node_modules/lz-string/libs/lz-string.js
var lz_string = __webpack_require__(26961);
var lz_string_default = /*#__PURE__*/__webpack_require__.n(lz_string);
;// CONCATENATED MODULE: ./src/dashboard/components/gridComponents/IkiProcessBuilder.jsx
 /**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const IkiProcessBuilder_iframeEmptyURL = `${widgetReferrerURL}/widget/diagram/builder`;

const IkiProcessBuilder_propTypes = {
  id: (prop_types_default()).string.isRequired,
  parentId: (prop_types_default()).string.isRequired,
  component: propShapes/* componentShape.isRequired */.cP.isRequired,
  parentComponent: propShapes/* componentShape.isRequired */.cP.isRequired,
...
const IkiProcessBuilder_defaultProps = {};
...
const IkiProcessBuilder_MARKDOWN_ERROR_MESSAGE = (0,TranslatorSingleton.t)('This markdown component has an error.');
...
class IkiProcessBuilder extends react.PureComponent {
  ...
  componentDidMount() {
    ...
    if (!this.props.component.meta.code) {
      this.setState(
      {
        iframeUrl: `${IkiProcessBuilder_iframeEmptyURL}?mode=edit` },
        ...
        messageObject.dataType)
        {
          ...
          if (messageObject.info === 'widget-to-superset/edit') {
...

            {
              ...
              const infoStringCompresed = lz_string_default().compressToEncodedURIComponent(
              infoString);
  ...
  renderEditMode() {
    ...
    if (markdownSource) {
      ...
      html = `<iframe id="ikiprocessdiagram-widget-${this.props.component.id}" src="${IkiProcessBuilder_iframeEmptyURL}" title="IkiProcessDiagram Component" class="ikiprocessdiagram-iframe"></iframe>`;
    }
    return (0,emotion_react_browser_esm.jsx)(SafeMarkdown/* default */.Z, { source: hasError ? IkiProcessBuilder_MARKDOWN_ERROR_MESSAGE : html });
  }
...
IkiProcessBuilder.propTypes = IkiProcessBuilder_propTypes;
IkiProcessBuilder.defaultProps = IkiProcessBuilder_defaultProps;

function IkiProcessBuilder_mapStateToProps(state) {
  return {
    undoLength: state.dashboardLayout.past.length,
    redoLength: state.dashboardLayout.future.length };

}
/* harmony default export */ const gridComponents_IkiProcessBuilder = ((0,es/* connect */.$j)(IkiProcessBuilder_mapStateToProps)(IkiProcessBuilder));
...
const componentLookup = {
  ...
  [componentTypes/* IKI_TABLE_TYPE */.aG]: gridComponents_IkiTable,
  [componentTypes/* IKI_PROCESS_BUILDER_TYPE */.Ap]: gridComponents_IkiProcessBuilder };
...
const FilterSets_Footer_Footer = ({ onCancel, editMode, onEdit, onCreate, disabled, filterSetName }) => {
  ...
  (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { buttonStyle: "tertiary", buttonSize: "small", onClick: onCancel, "data-test": "filter-set-cancel-button" },
  (0,TranslatorSingleton.t)('Cancel')),
...
const FiltersHeader = ({ dataMask, filterSet }) => {
  ...
  const getFilterRow = ({ id, name }) => {var _filterSet$nativeFilt, _dataMask$id, _dataMask$id$filterSt;
    ...
    (0,emotion_react_browser_esm.jsx)(StyledFilterRow, { "data-test": "filter-info" },
...
const EditSection = ({ filterSetId, onCancel, dataMaskSelected, disabled }) => {
  ...
  (0,emotion_react_browser_esm.jsx)(Button/* default */.Z, { ghost: true, buttonStyle: "tertiary", buttonSize: "small", onClick: onCancel, "data-test": "filter-set-edit-cancel" },
  (0,TranslatorSingleton.t)('Cancel')),
...
const FilterBar_Header_Header = ({ onApply, onClearAll, isApplyDisabled, dataMaskSelected, dataMaskApplied, toggleFiltersBar }) => {
  ...
  (0,emotion_react_browser_esm.jsx)(Icons/* default.Edit */.Z.Edit, { "data-test": "create-filter", iconColor: theme.colors.grayscale.base })),
...
const FilterValue_FilterValue = ({ dataMaskSelected, filter, directPathToChild, onFilterSelectionChange, inView = true }) => {var _filter$dataMask2, _filter$dataMask3, _filter$dataMask4;
  ...
  return (0,emotion_react_browser_esm.jsx)(FilterValue_StyledDiv, { "data-test": "form-item-value" },
...
const FilterControl = ({ dataMaskSelected, filter, icon, onFilterSelectionChange, directPathToChild, inView }) => {var _filter$dataMask, _filter$controlValues;
  ...
  (0,emotion_react_browser_esm.jsx)(Form/* FormItem */.xJ, { label: (0,emotion_react_browser_esm.jsx)(StyledFilterControlTitleBox, null,
    (0,emotion_react_browser_esm.jsx)(StyledFilterControlTitle, { "data-test": "filter-control-name" },
    name),

    (0,emotion_react_browser_esm.jsx)(StyledIcon, { "data-test": "filter-icon" }, icon)),
...
const CascadePopover = ({ dataMaskSelected, filter, visible, onVisibleChange, onFilterSelectionChange, directPathToChild, inView }) => {var _filter$cascadeChildr;
  ...
  (0,emotion_react_browser_esm.jsx)(CascadeFilters_CascadeFilterControl, { dataMaskSelected: dataMaskSelected, "data-test": "cascade-filters-control", key: filter.id, filter: filter, directPathToChild: visible ? currentPathToChild : undefined, onFilterSelectionChange: onFilterSelectionChange }));
...
const FilterControls = ({ directPathToChild, dataMaskSelected, onFilterSelectionChange }) => {
  ...
  (0,emotion_react_browser_esm.jsx)(CascadeFilters_CascadePopover, { "data-test": "cascade-filters-control", key: cascadeFilters[index].id, dataMaskSelected: dataMaskSelected, visible: visiblePopoverId === cascadeFilters[index].id, onVisibleChange: (visible) => setVisiblePopoverId(visible ? cascadeFilters[index].id : null), filter: cascadeFilters[index], onFilterSelectionChange: onFilterSelectionChange, directPathToChild: directPathToChild, inView: false }))),
...
class DashboardGrid extends react.PureComponent {
  ...
  render() {
    ...
    (0,emotion_react_browser_esm.jsx)("div", { className: "grid-content", "data-test": "grid-content" },
...
const DashboardContainer = ({ topLevelTabs }) => {var _useSelector;
  ...
  return (0,emotion_react_browser_esm.jsx)("div", { className: "grid-container", "data-test": "grid-container" },
  (0,emotion_react_browser_esm.jsx)(ParentSize, null,
  ({ width }) =>
  /*
...
const DashboardBuilder = () => {
  ...
  (0,emotion_react_browser_esm.jsx)(DragDroppable, { "data-test": "top-level-tabs", component: dashboardRoot, parentComponent: null, depth: constants/* DASHBOARD_ROOT_DEPTH */.Mu, index: 0, orientation: "column", onDrop: handleDrop, editMode: editMode
  ...
  (0,emotion_react_browser_esm.jsx)(emotion_react_browser_esm.Global, { styles: emotion_react_browser_esm.css`
    ...
    `div > .filterStatusPopover.ant-popover{z-index: 101}`}
          ` }),
  (0,emotion_react_browser_esm.jsx)("div", { "data-test": "dashboard-content", className: classnames_default()('dashboard', editMode && 'dashboard--editing') },
